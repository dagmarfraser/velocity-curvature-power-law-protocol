function [beta,yGain, stats] = regressDataEBR(responses, predictors, regressType, LMseeds, displayGraphs)
...
%
%% outputs
% estimates of Beta and VGF, associated stats
...
switch regressType
    ...
    case 3
        ...
        yGain = mdlTbeta.Coefficients.Estimate(1);
        if displayGraphs
            figure(1002)
            clf
            plot(mdlTbeta)
    ...
    case 4
        ...
        yGain = log(mdlLMbeta.Coefficients.Estimate(1));
